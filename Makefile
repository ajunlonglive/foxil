...
.PHONY: all format test test-compiler test-checks run-examples help
.SILENT: build format test test-compiler test-checks run-examples help
...
run-examples: ## Run all examples
	...
	$(VRUN) examples/run_examples.vsh
